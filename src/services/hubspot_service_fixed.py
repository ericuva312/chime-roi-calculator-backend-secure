...
def upsert_contact(submission):
    ...
    try:
        ...
        properties = {
            ...
            'notes_last_contacted': f"ROI Calculator Lead - Score: {submission.lead_score}, Tier: {submission.tier}",
            'notes_last_updated': f"Monthly Revenue: ${submission.monthly_revenue:,.0f}, Industry: {submission.industry}"
        }
...
def create_deal(submission, contact_id):
    ...
    try:
        ...
        properties = {
            ...
            'hs_deal_stage_probability': '40',  # 40% probability for qualified stage
